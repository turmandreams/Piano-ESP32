...
void luces(){
  ...
  if(teclas[0]){  pixels.setPixelColor(0,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(0,pixels.Color(0,0,0));  }
  if(teclas[2]){  pixels.setPixelColor(1,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(1,pixels.Color(0,0,0));  }
  if(teclas[4]){  pixels.setPixelColor(2,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(2,pixels.Color(0,0,0));  }
  if(teclas[5]){  pixels.setPixelColor(3,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(3,pixels.Color(0,0,0));  }
  if(teclas[7]){  pixels.setPixelColor(4,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(4,pixels.Color(0,0,0));  }
  if(teclas[9]){  pixels.setPixelColor(5,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(5,pixels.Color(0,0,0));  }
  if(teclas[11]){ pixels.setPixelColor(6,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(6,pixels.Color(0,0,0));  }
  
  if(teclas[12]){  pixels.setPixelColor(7,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(7,pixels.Color(0,0,0));  }
  if(teclas[14]){  pixels.setPixelColor(8,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(8,pixels.Color(0,0,0));  }
  if(teclas[16]){  pixels.setPixelColor(9,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(9,pixels.Color(0,0,0));  }
  if(teclas[17]){  pixels.setPixelColor(10,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(10,pixels.Color(0,0,0));  }
  if(teclas[19]){  pixels.setPixelColor(11,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(11,pixels.Color(0,0,0));  }
  if(teclas[21]){  pixels.setPixelColor(12,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(12,pixels.Color(0,0,0));  }
  if(teclas[23]){  pixels.setPixelColor(13,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(13,pixels.Color(0,0,0));  }
  
  if(teclas[24]){  pixels.setPixelColor(14,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(14,pixels.Color(0,0,0));  }
  if(teclas[26]){  pixels.setPixelColor(15,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(15,pixels.Color(0,0,0));  }
  if(teclas[28]){  pixels.setPixelColor(16,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(16,pixels.Color(0,0,0));  }
  if(teclas[29]){  pixels.setPixelColor(17,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(17,pixels.Color(0,0,0));  }
  if(teclas[31]){  pixels.setPixelColor(18,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(18,pixels.Color(0,0,0));  }
  if(teclas[33]){  pixels.setPixelColor(19,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(19,pixels.Color(0,0,0));  }
  if(teclas[35]){  pixels.setPixelColor(20,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(20,pixels.Color(0,0,0));  }
  
  if(teclas[36]){  pixels.setPixelColor(21,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(21,pixels.Color(0,0,0));  }
  if(teclas[38]){  pixels.setPixelColor(22,pixels.Color(0,0,50));  }else {  pixels.setPixelColor(22,pixels.Color(0,0,0));  }
    ...
    for(int i=0;i<4;i++){
      ...
      if(sonidorelleno[i]){  
        ...
        for(int jj=0;jj<39;jj++){
          ...
          if(possonido[jj]<(tamsonido[i]-2000)){
