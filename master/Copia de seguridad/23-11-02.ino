...
void ledfondo(int i){
    ...
    else if(colordefondo==5){ r=200;g=50;b=50;}
  ...
  valor=analogRead(34);if(valor<255){  //Boton Abajo
     if(menuplaying){
       ...
       if(menu==0){
          ...
          efectochorus[canalseleccionado]-=0.2;
          if(efectochorus[canalseleccionado]<0){ efectochorus[canalseleccionado]=0;}
          menupantalla();  
       }       
     }
  ...
  valor=analogRead(35);if(valor<255){ //Boton Arriba
     ...
     if(menuplaying){
       ...
       if(menu==0){
          ...
          efectochorus[canalseleccionado]+=0.2;
          if(efectochorus[canalseleccionado]>10){ efectochorus[canalseleccionado]=10;}
          menupantalla();  
       }
...
void menupantalla(){
  ...
  if(menu==0){
    ...
    if(efectochorus[canalseleccionado]==0){ texto="OFF"; }
    drawCentreString(texto,64,52,1);    
  }
